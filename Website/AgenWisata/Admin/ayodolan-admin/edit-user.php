...
<html lang="en">
  ...
  <body>
        ...
        <div class="logo-brand" style="text-align: center; padding-top: 20px;">
            <a href="sebelumnya.php"><img src="images/branding-logo.png" alt="Logo" style="opacity: .8; width: 85%;"></a>
        </div>
        <!-- /Brand Logo -->
          ...
          <div class="user" style="padding-top: 15px;">
	        ...
	        <ul class="list-unstyled components mb-5" style="margin-top: 3rem !important;">
	          <li>
	            <a href="sebelumnya.php"><i class="fa fa-fw fa-home"></i> Dashboard</a>
	          </li>
	          <li class="active">
      ...
      <div id="content" class="p-4 p-md-5">
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <li class="nav-item active">
                  ...
                  <a style="color: #292929;">Edit Akun User</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <h2 class="mb-4">Edit Akun User</h2>

        <!-- List Tabel -->
        <?php
        require('config.php');
        $target = $_GET['target'];
        $sql = "SELECT * FROM pendaftaran where id_pelanggan = '$target'";
    ...
    <form action="update-user.php" method="POST">
        ...
        <input type="text" name="email" class="form-control" placeholder="Alamat Email Anda" value="<?php echo $row['email_pelanggan'];?>">
        <br>
        Kata Sandi :
        <span class="error">*</span>
        <input type="password" name="katasandi" class="form-control" placeholder="Kata Sandi Anda" value="<?php echo $row['kataSandi_pelanggan'];?>">
        <br>  
        Nama Lengkap  :
        <span class="error">*</span>
        <input type="text" name="nama" class="form-control" placeholder="Nama Lengkap Anda" value="<?php echo $row['nama_pelanggan'];?>">
        <br>
        Tanggal Lahir   :
        <span class="error">*</span>
        <input type="date" name="tanggallahir" class="form-control" placeholder="Tanggal Lahir Anda" value="<?php echo $row['tglLahir_pelanggan'];?>">
        <br>
        Jenis Kelamin   :
        <span class="error">*</span>
        <br>
        <input type="radio" name="jeniskelamin" value="Laki-laki" <?php if($row['kelamin_pelanggan']=="Laki-laki") { echo 'checked';}?>>
        <label for="lk">Laki-laki</label>
        <input type="radio" name="jeniskelamin" value="Perempuan" <?php if($row['kelamin_pelanggan']=="Perempuan") { echo 'checked';}?>>
        <label for="pr">Perempuan</label>
        <br>
        Alamat :
        <span class="error">*</span>
        <textarea name="alamat" class="form-control" placeholder="Alamat Anda"><?php echo $row['alamat_pelanggan'];?></textarea>
        <br>
        Nomor Telepon :
        <span class="error">*</span>
        <input type="text" name="nohp" class="form-control" placeholder="Nomor Telepon Anda" value="<?php echo $row['telp_pelanggan'];?>">
        <br>
        Kewarganegaraan :
        <span class="error">*</span>
        <input type="text" name="kewarganegaraan" class="form-control" placeholder="Kewarganegaraan Anda" value="<?php echo $row['kewarganegaraan'];?>">
        <br>
