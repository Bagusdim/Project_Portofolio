      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <!-- List Tabel -->
          <h6>Paket Wisata yang Tersedia</h6>
            <?php
              require('config.php');
              $sql = "SELECT * FROM paket_wisata JOIN detail_paket USING (idDetail_paket)";
              ...
              if($result->num_rows > 0) {
                  ...
                  while($row = $result -> fetch_assoc()){
                      ...
                      <td> 
                      <a href='edit.php?target=".$row["id_paket"]."'> <i class='fa fa-pencil-square-o'></i>
                      <a href=hapus.php?id=".$row["id_paket"]." onclick=\"return confirm('Apakah anda yakin untuk menghapus?')\"><i class='fa fa-trash-o'></i></a>
                      </td>
                  </tr>";
                    }
                  echo "</table></div>";
