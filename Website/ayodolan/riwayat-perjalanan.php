            ...
            <div class="u-layout-row" style="border: solid 3px #CCC;">
              ...
              <div class="u-container-style u-expand-resize u-layout-cell u-right-cell u-size-47 u-layout-cell-2" >
                <div class="u-container-layout u-container-layout-2" style="width: 100px;">
                  ...
                  <?php
                    require('config.php');
                    $sql = "SELECT * FROM pemesanan JOIN paket_wisata USING(id_paket) WHERE id_pelanggan='$_SESSION[id_pelanggan]'";
                    $result = mysqli_query($conn, $sql);
                    if($result->num_rows > 0) {
                        ...
                        while($row = $result -> fetch_assoc()){
                            $totaltagihan = $row["harga_paket"] * $row["jumlah_orang"];
                            echo "<tr><td>" . $row["id_pemesanan"]. "</td>
                            <td>" . $row["id_paket"]. "</td>
                            <td>" . $row["kota"]. "</td>
                            <td>" . $row["tgl_mulai"]. "</td>
                            ...
                            <td>" . $row["status"]. "</td>
                            <td> 
                            <a href='bayar.php?target=".$row["id_pemesanan"]."'> Bayar Sekarang
                            </td>
                         </tr>";
                          }
                        echo "</table></div>";
