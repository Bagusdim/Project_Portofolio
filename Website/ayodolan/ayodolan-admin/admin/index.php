            ...
            <div class="small-box bg-unpaid">
              <div class="inner">
                <h3>
                  <?php
                    require('config.php');
                    $sql = "SELECT * FROM pemesanan WHERE status='BELUM BAYAR'";
                    $result = mysqli_query($conn, $sql);
          ...
          <?php
            ...
            if($result->num_rows > 0) {
                ...
                while($row = $result -> fetch_assoc()){
                    ...
                    <td>" . $row["status"]. "</td>
                    <td> 
                    <a href='edit-dashboard.php?target=".$row["id_paket"]."'> <i class='fa fa-pencil-square-o'></i>
                    <a href=hapus-dashboard.php?id=".$row["id_paket"]." onclick=\"return confirm('Apakah anda yakin untuk menghapus?')\"><i class='fa fa-trash-o'></i></a>
                     </td>
                 </tr>";
                  }
                echo "</table></div>";
