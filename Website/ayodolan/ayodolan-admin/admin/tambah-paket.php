    ...
    ?> 
      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <?php
            ...
            else if (isset($_GET['nama_paket'])){
              if ($_GET['nama_paket'] == "nama_paketkosong"){
                  echo "<h4 style='color:red'>Nama Paket harus diisi!</h4>";
              }
            }

            else if (isset($_GET['id_paket'])){
              if ($_GET['id_paket'] == "id_paketkosong"){
                  echo "<h4 style='color:red'>ID Paket harus diisi!</h4>";
              }
              else if ($_GET['id_paket'] == "id_paketErr"){
                  echo "<h4 style='color:red'>ID Paket hanya bisa diisi dengan 4 huruf kapital diikuti 4 angka</h4>";
              }
            }
            ...
            ?>
                ...
                <form action="submit-paket.php" method="POST" enctype="multipart/form-data">
                  ID Paket  :
                  <span class="error">*</span>
                  <input type="text" name="id_paket" class="form-control" placeholder="ID Paket">
                  <br>
                  Nama Paket :
                  <span class="error">*</span>
                  ...
                  Foto Wisata :
                  <span class="error">*</span>
                  <input type="file" name="gambar" class="form-control" placeholder="Foto Preview Wisata">
                  <br>
                  Lokasi :
                  <span class="error">*</span>
