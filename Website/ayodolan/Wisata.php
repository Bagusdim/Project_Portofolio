...
<html style="font-size: 16px;">
  <head>
    ...
    <title>AYODOLAN - Paket Wisata</title>
  ...
  <body class="u-body"><header class="u-align-center-sm u-align-center-xs u-clearfix u-header u-header" id="sec-941d"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-section-1" id="sec-3762" style="padding-bottom:70px">
              ...
              ?>  <div class="konten">
                  <div class="column">
                    <div class="card" style="margin: 20px;">
                      <?php echo "<img src='images/wisata/$data[gambar]' height='270' alt='Avatar'>"; ?>
                      <div class="container" style="margin-top: 20px; text-align:center;"> 
                        <h4><?php echo $data["nama_paket"]?></h4>
                        <h6 style="color: crimson;">IDR <?php echo $data["harga_paket"]?> / PAX</h6>
                        <br>
                        <a href="Booking.php" class="btn btn-warning" style="color:white;">Pesan Sekarang</a>
                        <p class="u-text u-text-8">
                          Destinasi Kota <?php echo $data["kota"]?>&nbsp;
                          <br><?php echo $data["durasi"] . " hari"?>
                        </p>
                      </div>
                    </div>
                  </div>
